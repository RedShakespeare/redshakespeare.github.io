...
function renderVideoPlayer(video) {
  ...
  const volumeIcon = icon('volume', '<path d="M3 10v4h4l5 4V6L7 10zm12.5 2a3.5 3.5 0 0 0-2-3.15v6.29A3.5 3.5 0 0 0 15.5 12z"/>') + icon('muted', '<path d="M3 10v4h4l5 4V6L7 10zm11-1 6 6m0-6-6 6" fill="none" stroke="currentColor" stroke-width="2"/>');
  return `${PLAYER_START}
<aside class="sil-video-player" data-sil-video-player data-sil-video-model="${model}" tabindex="0" aria-label="视频播放器" style="--sil-video-aspect-ratio:${escapeHtml(video.aspectRatio)}">
  ...
  <div class="sil-video-player__toolbar" role="group" aria-label="视频控制">
    ...
    <div class="sil-video-player__volume-control">
      ...
      <div class="sil-video-player__volume-popover"><input class="sil-video-player__range sil-video-player__volume" data-sil-video-volume type="range" min="0" max="1" step="0.05" value="1" aria-label="音量"></div>
    </div>
    ...
    <button class="sil-video-player__button" data-sil-video-action="repeat" type="button" aria-label="播放一次" aria-pressed="false">${icon('repeat', '<path d="M7 7h10l-2.5-2.5L16 3l5 5-5 5-1.5-1.5L17 9H7a3 3 0 0 0-3 3v1H2v-1a5 5 0 0 1 5-5zm10 8H7l2.5 2.5L8 19l-5-5 5-5 1.5 1.5L7 13h10a3 3 0 0 0 3-3V9h2v1a5 5 0 0 1-5 5z"/>')}</button>
