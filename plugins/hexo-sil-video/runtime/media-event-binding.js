...
export function bindMediaEvents({ video, progress, duration, projection, setStatus, onPlayInteraction }) {
  ...
  scope.listen(video, 'pause', projection.playing);
  scope.listen(video, 'ended', projection.playing);
