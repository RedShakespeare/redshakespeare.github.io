...
#define MORIA_HOU	"/usr/local/games/lib/moria/hours"
#define MORIA_MOR	"/usr/local/games/lib/moria/news"
#define MORIA_TOP	"/usr/local/games/lib/moria/scores"
#define MORIA_HELP	"/usr/local/games/lib/moria/roglcmds.hlp"
#define MORIA_ORIG_HELP	"/usr/local/games/lib/moria/origcmds.hlp"
#define MORIA_WIZ_HELP	"/usr/local/games/lib/moria/rwizcmds.hlp"
#define MORIA_OWIZ_HELP	"/usr/local/games/lib/moria/owizcmds.hlp"
#define MORIA_WELCOME	"/usr/local/games/lib/moria/welcome.hlp"
#define MORIA_VER	"/usr/local/games/lib/moria/version.hlp"
