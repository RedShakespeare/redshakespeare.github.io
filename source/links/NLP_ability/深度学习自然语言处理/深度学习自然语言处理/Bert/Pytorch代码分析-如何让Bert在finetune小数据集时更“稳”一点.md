...
![loss_adam](/links/NLP_ability/深度学习自然语言处理/Bert/images/loss_adam.png)

可以看到，没有使用偏移纠正的 loss 收敛的更加的迅速一点，反而使用了修正的模型收敛的慢一点。但是同时可以观测到，修正之后，模型的收敛更加的稳定，相比较而言，并没有特别大的震荡。

Acc变化如下图（后期没怎么变化，所以截取了前300steps）：

![acc_corre](/links/NLP_ability/深度学习自然语言处理/Bert/images/acc_corre.png)
...
![loss_pool](/links/NLP_ability/深度学习自然语言处理/Bert/images/loss_pool.png)
